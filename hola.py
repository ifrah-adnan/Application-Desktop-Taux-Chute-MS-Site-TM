...
class Ui_Hola(object):
    def loaddata(self):
        ...
        for row in range(self.tableWidget.rowCount()):
                    ...
                    self.tableWidget.setCellWidget(row, 6, button)
          ...
          for ep_interv in ep_stock:     
            if '<<' in ep_interv:
                ...
                for row in range(self.tableWidget2.rowCount()):
                    button = QPushButton('Cliquez ici')
                    self.tableWidget2.setCellWidget(row, 3, button)
    ...
    def next(self,infos):
          ...
          epaisseur_st=self.tableWidget2.item(int(row), 0).text()
          largeur_st=self.tableWidget2.item(int(row),  1).text()
    ...
    def setupUi(self, MainWindow):
        ...
        self.tableWidget.setGeometry(QtCore.QRect(10, 180, 900, 350))
...
"")
        ...
        self.tableWidget2.setGeometry(QtCore.QRect(1100, 180, 700, 350))
...
"")
        ...
        self.tableWidget_3.setGeometry(QtCore.QRect(500, 600,700 ,350 ))
